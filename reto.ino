...
const char ssid[] = "iPhone de Manolo";
//Contraseña de la red Wifi
const char pass[] = "manolito123";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "m.hernandezr2"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "m.hernandezr2";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "202224469";
...
void loop()
{
  ...
  //Se lee el valor del GL5516 desde el pin analógico A0.
  //Este valor indica el nivel de luz del ambiente y luego se convierte a porcentaje
  int ldr_raw = analogRead(ldr_apin);
  float lum_pct = (ldr_raw / 1023.0) * 100.0;
  ...
  //JSON para luminosidad (se envía como porcentaje)
  json = "{\"value\": "+ String(lum_pct, 2) + "}";
